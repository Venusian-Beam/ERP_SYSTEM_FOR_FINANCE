...
Route::post('webhooks/conversational', \App\Http\Controllers\ConversationalGatewayController::class)->middleware('twilio.signed')->name('webhooks.conversational');

// Guest auth routes (login page — no tenant scope needed)
require __DIR__.'/auth.php';

// Authenticated, tenant-scoped Inertia routes
